...
namespace Aiirh.Basic.Services.Http
{
    public abstract class BaseExternalHttpClient<T> : BaseHttpClient
    {
        ...
        protected BaseExternalHttpClient(IHttpClientBuilder httpClientBuilder,
            IMemoryCacheManager cacheManager,
            HttpClientSettings clientSettings) : base(cacheManager, httpClientBuilder, typeof(T).Name)
        {

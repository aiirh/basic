...
public class NumericRangeTests
{
    ...
    [Test]
    [TestCaseSource(nameof(GetTestIntersectsBorderNotIncluded))]
    ...
    [Test]
    [TestCaseSource(nameof(GetTestIntersectsBorderIncluded))]
    ...
    private static IEnumerable<TestCaseData> GetTestDataForConcatRanges()
    {
        ...
        var initial4 = Enumerable.Empty<NumericRange>();
        var range4 = new NumericRange(5, 25);
        var expected4 = new[] { new NumericRange(5, 25) };
        yield return new TestCaseData(initial4, range4, expected4, "ACACAF16-F335-48BB-BC6F-DD122CFDD568");
    }
    ...
    private static IEnumerable<TestCaseData> GetTestIntersectsBorderIncluded()
    {
        ...
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, 1), true, "E1683902-0880-4C78-9200-9F827AEB9C42");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(10, 20), true, "1E20EE5F-BA4F-4C57-BD07-FD073A4F6779");
    ...
    private static IEnumerable<TestCaseData> GetTestIntersectsBorderNotIncluded()
    {
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(1, 10), true, "07FAF91D-FC34-4FFA-8B09-CA0442F36F40");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(1, 11), true, "C98312F3-581F-4A8C-9BD2-1C0B8ABF713D");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, 10), true, "BC35C5FE-EFD8-419E-9B59-3555B4174683");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, 9), true, "996DF4EB-9EB4-4B42-A883-44796CBE7CE5");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(2, 9), true, "04FD266A-49FC-444C-AF29-D8E9DB3D7244");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(2, 11), true, "8AE62460-5C34-41D3-961C-2B741B9706FD");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(0, 9), true, "5CD9EABF-267F-4768-965C-E557668EDC33");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(0, 11), true, "E3502C4C-6ED5-43FC-A57B-2D752C93654D");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, 0), false, "45AE0378-9C06-44C2-961E-AAC25899EB39");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, 1), false, "F0529835-1E5E-41AA-8406-195F8A4CF4A5");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(10, 20), false, "69278585-6E43-4573-9A4A-37D8A6D2FE2E");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(11, 20), false, "00FC4577-1EE6-41EA-918D-AA26B59367FF");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(12, 20), false, "45F540D2-9523-4C5A-B20F-248ECA685E52");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, -1), false, "940E262C-CCC3-4C81-AE8C-BD5D1E530A6C");
    }
    ...
    private static IEnumerable<TestCaseData> GetTestIntersectsOrCommonBorder()
    {
        ...
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(-10, 1), true, "294F8274-2FCD-45E3-B855-B4FD5371BFFD");
        yield return new TestCaseData(new NumericRange(1, 10), new NumericRange(10, 20), true, "255AEF46-E099-4BB7-B45B-CBDE5A4B3F84");

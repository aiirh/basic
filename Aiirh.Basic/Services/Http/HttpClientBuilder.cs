...
namespace Aiirh.Basic.Services.Http
{
    ...
    /// HttpClientBuilder
    /// </summary>
    /// <seealso cref="T:Aiirh.Basic.Services.Http.IHttpClientBuilder" />
    public class HttpClientBuilder : IHttpClientBuilder
    {
        ...
        public HttpClientBuilder(IMessageLogSystemWriter messageLogWriter, ILogger logger)
        {
        ...
        {
            var client = new ExtendedHttpClient(InitHandler(args), _messageLogWriter, _logger)
            {
